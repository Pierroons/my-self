...
return [
    ...
    'prf.memo.create' => 'Crée ton coffre chiffré. Le <strong>mot de passe</strong> sert au quotidien ; la <strong>passphrase de récupération</strong> te permet de retrouver le mémo si tu perds ton mot de passe.',
