...
return [
    ...
    'prf.memo.create' => 'Create your encrypted vault. The <strong>password</strong> is for everyday use; the <strong>recovery passphrase</strong> lets you retrieve the memo if you lose your password.',
