...
function su_audit_ntfy(array $entry): void {
    $url = getenv('SELFRECOVER_NTFY_URL'); // ex https://ntfy.example/your-topic
    if (!$url) return;
    $token = getenv('SELFRECOVER_NTFY_TOKEN') ?: ''; // requis si l'instance ntfy est deny-all (votre serveur ntfy en deny-all)
