...
[![Statut : v0.2.0 bêta](https://img.shields.io/badge/statut-v0.2.0%20b%C3%AAta-green.svg)](#statut)
...
**v0.2.0 — en production sur [justice.my-self.fr](https://justice.my-self.fr)**

- [x] Directives système (procédure d'analyse en 7 étapes, 5 principes)
- [x] 7 catégories juridiques (travail, logement, famille, voisinage, consommation, civil, pénal)
- [x] Points d'entrée détaillés pour le droit du logement et le droit de la famille
...
- **v0.2.0 (actuelle)** — Droit de la famille (divorce, garde, pension) + droit du logement (baux, expulsion)
