...
Le script avait pourtant crié le jour même — « Aucune decision ajoutee. Verifier
la fenetre de reprise. » L'alerte est partie ; personne ne l'a lue. Ce banc
existe pour que le défaut ne dépende plus de quelqu'un qui ouvre un journal.
...
def main() -> int:
    ...
    # 🔑 Le seuil est mesuré, pas choisi : 97 % des décisions de 2026 étaient
    # publiées sous 29 jours, 99,8 % sous 59. Un seuil inférieur à 30 laisserait
    # passer une décision sur quatre.
